...
class Excel extends Component{
	...
	_renderFormDialog(readonly){
		return(
			...
			>
			<Form ref="form" fields={this.props.schema} initialData={this.state.data[this.state.dialog.idx]} readonly={readonly}/>
			</Dialog>
		)
	}
						...
						return(
							<tr key={rowidx}>
								...
								<td className="ExcelDataCenter">
									<Action onAction={this._actionClick.bind(this,rowidx)}/>
								</td>
							</tr>
						)
					})}
